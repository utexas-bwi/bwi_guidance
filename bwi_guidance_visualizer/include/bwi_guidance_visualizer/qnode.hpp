/**
 * @file /include/bwi_guidance_visualizer/qnode.hpp
 *
...
#ifndef bwi_guidance_visualizer_QNODE_HPP_
#define bwi_guidance_visualizer_QNODE_HPP_
...
*****************************************************************************/
  ...
  class QNode : public QThread {
    ...
    private:
      ...
      bwi_guidance::Experiment experiments_;
      std::vector<bwi_guidance::User> users_;
      std::vector< std::vector<size_t> > user_box_to_idx_map_;
      std::vector< std::vector< 
        std::vector<bwi_guidance::LocationStamped> > > odometry_;

  };

}  // namespace bwi_guidance_visualizer

#endif /* bwi_guidance_visualizer_QNODE_HPP_ */
