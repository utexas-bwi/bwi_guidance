...
METHOD_NAMES = ['Heuristic', 'VI', 'UCT', 'Baseline']

MAX_ROBOTS = 1 # Compute this from the first line you encounter
    ...
    if len(method) > 1:
        ...
        for key,value in method.iteritems():
            ...
            if key == "lambda":
                ...
                param = "IS"
            elif key == "use_shaping_reward" and value == False:
                param = "NoShapingR"
            elif key == "h_improved" and value == True:
                param = "Improved"
