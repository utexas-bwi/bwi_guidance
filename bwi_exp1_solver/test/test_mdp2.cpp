...
void testModel2(topological_mapper::Graph& graph, const nav_msgs::OccupancyGrid &map) {
  // topological_mapper::Point2f p1 =
  //   topological_mapper::getLocationFromGraphId(80, graph);
  // topological_mapper::Point2f p2 =
  //   topological_mapper::getLocationFromGraphId(65, graph);
  // std::cout << p1 << p2 << std::endl; 
  // std::cout << topological_mapper::locationsInDirectLineOfSight(p1, p2, map) << std::endl;
