...
namespace bwi_guidance {
  ...
  namespace mrn {
    ...
    BaseRobotNavigator::BaseRobotNavigator(boost::shared_ptr<ros::NodeHandle>& nh) :
      nh_(nh), robot_screen_publisher_(nh) {

      // TODO - move images to common.
      ...
      // TODO - Subscribe to available_robots to find out which robots are available on the system.
      // TODO - Read in some parameters to figure out the experiment itself.
      // TODO - Get rid of position_publisher_
      // TODO - Get rid of gazebo_available_
      //
      ...
      odometry_subscriber_ = nh->subscribe("person/odom", 1, &BaseRobotNavigator::odometryCallback, this);

      current_instance_ = -1;
      instance_in_progress_ = false;
      experiment_status_subscriber_ =
        nh->subscribe("experiment_controller/experiment_status", 1, &BaseRobotNavigator::experimentCallback, this);

      prev_msg_ready_ = false;
    }

    void BaseRobotNavigator::finalizeExperimentInstance() {
    ...
    // TODO: This function needs to moved to common.
    void BaseRobotNavigator::produceDirectedArrowAlt(float orientation,
        cv::Mat& image) {
    ...
    // TODO: This function needs to moved to common.
    void BaseRobotNavigator::produceDirectedArrow(float orientation,
        cv::Mat& image) {
    ...
    void BaseRobotNavigator::experimentCallback(
    ...
    geometry_msgs::Pose BaseRobotNavigator::convert2dToPose(
    ...
    // TODO - this actually needs to start navigating the robot instead of teleporting it.
    bool BaseRobotNavigator::teleportEntity(const std::string& entity,
    ...
    // TODO needs to move to common.
    geometry_msgs::Pose BaseRobotNavigator::positionRobot(
